...
/// <summary>
/// Parent response type for a cache list push front request. The
/// response object is resolved to a type-safe object of one of
/// the following subtypes:
/// <list type="bullet">
/// <item><description>CacheListPushFrontResponse.Success</description></item>
/// <item><description>CacheListPushFrontResponse.Error</description></item>
/// </list>
/// Pattern matching can be used to operate on the appropriate subtype.
/// For example:
/// <code>
/// if (response is CacheListPushFrontResponse.Success successResponse)
/// {
///     return successResponse.ListLength;
/// }
/// else if (response is CacheListPushFrontResponse.Error errorResponse)
/// {
