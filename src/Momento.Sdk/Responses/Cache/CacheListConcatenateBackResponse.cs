...
/// <summary>
/// Parent response type for a cache list concatenate back request. The
/// response object is resolved to a type-safe object of one of
/// the following subtypes:
/// <list type="bullet">
/// <item><description>CacheListConcatenateBackResponse.Success</description></item>
/// <item><description>CacheListConcatenateBackResponse.Error</description></item>
/// </list>
/// Pattern matching can be used to operate on the appropriate subtype.
/// For example:
/// <code>
/// if (response is CacheListConcatenateBackResponse.Success successResponse)
/// {
///     return successResponse.ListLength;
/// }
/// else if (response is CacheListConcatenateBackResponse.Error errorResponse)
/// {
