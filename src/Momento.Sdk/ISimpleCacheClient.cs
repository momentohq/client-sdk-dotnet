...
public interface ISimpleCacheClient : IDisposable
{
    ...
    /// <param name="ttlSeconds">TTL for the item in cache. This TTL takes precedence over the TTL used when initializing a cache client. Defaults to client TTL. If specified must be strictly positive.</param>
    /// <returns>
