...
[Collection("TopicClientApiKeyV2")]
public class TopicTestApiKeyV2 : IClassFixture<CacheClientApiKeyV2Fixture>, IClassFixture<TopicClientApiKeyV2Fixture>
{
    private readonly string cacheName;
    private readonly ITopicClient topicClient;

    public TopicTestApiKeyV2(CacheClientApiKeyV2Fixture cacheFixture, TopicClientApiKeyV2Fixture topicFixture)
    {
